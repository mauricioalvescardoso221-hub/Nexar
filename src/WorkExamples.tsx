...
// Suggestion: Rename this file and component to "WorkExamples.tsx" to better reflect its content.
const WorkExamples = () => {
  const images = [
    {
  ...
  const videos = [
    {
      src: "/videos/instalacao-academia.mp4",
      poster: "/images/service13.jpg",
      title: "Instalação de Quadro de Disjuntores",
    },
    {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {videos.map((video) => (
                <div key={video.src} className="bg-slate-800 rounded-lg shadow-lg overflow-hidden">
